...
update Skills set comments = 'Supervised learning, in the context of artificial intelligence (AI) and machine learning, is a type of system in which both input and desired output data are provided. Input and output data are labelled for classification to provide a learning basis for future data processing.' where lower(skill) = lower('Supervised Learning');
update Skills set comments = 'Unsupervised learning is the training of an artificial intelligence (AI) algorithm using information that is neither classified nor labeled and allowing the algorithm to act on that information without guidance.' where lower(skill) = lower('Supervised Learning');
update Skills set comments = 'Deep learning is a type of machine learning that uses a cascade of multiple layers to contribute to feature extraction and transformation. Deep learning can be applied to both supervised and unsupervised ML algorithms and has been transformational in the fields of computer vision, natural language process, robotics, and many others.' where lower(skill) = lower('Unsupervised Learning');
update Skills set comments = 'Data visualization describes any effort to help people understand the significance of data by placing it in a visual context. Patterns, trends and correlations that might go undetected in text-based data can be exposed and recognized easier with data visualization software.' where lower(skill) = lower('Deep Learning');
update Skills set comments = 'Descriptive statistics are used to describe the basic features of the data in a study. They provide simple summaries about the sample and the measures. They form the basis of virtually every quantitative analysis of data.' where lower(skill) = lower('Data Visualization');
update Skills set comments = 'Inferential statistics use a random sample of data taken from a population to describe and make inferences about the population' where lower(skill) = lower('descriptive statistics');
update Skills set comments = 'Inferential statistics use a random sample of data taken from a population to describe and make inferences about the population' where lower(skill) = lower('inferential statistics');
update Skills set comments = 'Data mining is the process of sorting through large data sets to identify patterns and establish relationships to solve problems through data analysis and to predict future trends.' where lower(skill) = lower('Data Mining');
update Skills set comments = 'Extremely large data sets that may be analyzed computationally to reveal patterns, trends, and associations, especially relating to human behavior and interactions' where lower(skill) = lower('Big Data');
update Skills set comments = 'Data manipulation is the process of changing data in an effort to make it easier to read or be more organized or structured' where lower(skill) = lower('Data Manipulation');
update Skills set comments = 'Relational data structures. Using structured query language (SQL) for defining and manipulating data.' where lower(skill) = lower('SQL');
update Skills set comments = 'NoSQL databases. Dynamic schema for unstructured data. Data is stored in many ways: icolumn-oriented, document-oriented, graph-based or organized as a KeyValue store' where lower(skill) = lower('NoSQL');
