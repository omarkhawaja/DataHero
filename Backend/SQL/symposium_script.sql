...
*/
CREATE DATABASE IF NOT EXISTS fydp_symposium;
USE fydp_symposium;
...
insert into Course_providors (name,url) values ('Udemy','https://www.udemy.com');
insert into Course_providors (name,url) values ('Coursera','https://www.coursera.org/recommendations');
insert into Course_providors (name,url) values ('Edx','https://www.edx.org');
insert into Course_providors (name,url) values ('Udacity','https://www.udacity.com');
...
insert into Course_instructors (id,name) values (613,'N/A');
...
BEGIN
	...
	get_position_skills: LOOP
        ...
        IF skill_ = 'tableau' or skill_ = 'bash' or skill_ = 'sas'  THEN
			# ;)
...
call delete_dups;
call position_skill_data_loading;
