...
<body data-spy="scroll" data-target=".navbar-collapse">
    ...
    <div class="container contentContainer" id="topContainer">
        <div class="row">
            <div class="col-md-6 col-md-offset-1" id="topRow">
                <h1> Welcome to your dashboard
                    <?php if($_SESSION['fname']) echo(', '.$_SESSION['fname'].'!'); else echo("!");?>
                </h1>
            </div>
        </div>
        <div class="row">
            <div class="col wide col-md-offset-3">
                <?php 
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-5 marginTop">
